...
- `assets/limine/`: Limine boot-menu theme (wallpaper + `theme.conf` global block) with the two commands to apply it by hand; the live ISO's pretty menu was GRUB, the installed Limine ships bare
