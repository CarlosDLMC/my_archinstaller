...
# Check for required tools (foot)
if ! command -v foot &> /dev/null; then
  notify-send -i "$iDIR/error.png" "Need Foot:" "Foot terminal not found. Please install Foot terminal."
  exit 1
fi
