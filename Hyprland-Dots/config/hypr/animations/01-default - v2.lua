...
hl.curve("nice", { type = "bezier", points = { {0, 2}, {0.5, -1} } }) -- was -4.20: clamped, Lua limits bezier points to [-1, 2]
...
hl.animation({ leaf = "borderangle", enabled = true, speed = 100, bezier = "linear", style = "loop"}) --used by rainbow borders and rotating colors -- was 180: clamped, Lua caps speed at 100
