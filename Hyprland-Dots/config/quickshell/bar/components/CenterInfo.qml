...
Item {
    ...
    property string centerTime: Qt.formatDateTime(new Date(), "HH:mm")
    ...
    function getTempColor(tempStr) {
        ...
        // Original colours, restored by request: the weather is the one place
        // in the bar that keeps a full hue ramp.
    ...
    function getConditionColor(condition) {
        ...
        // Original colours, restored by request.
    ...
    Row {
        ...
        Text {
            ...
            color: !dndAvailable ? Theme.colWarn : (dndEnabled ? Theme.colAlert : Theme.colCenterMuted)
            font.pixelSize: Theme.fontSize
            font.family: Theme.fontFamily
    ...
    Process {
        ...
        command: ["sh", "-c", "$HOME/.config/quickshell/bar/scripts/weather-fetch.sh 2>/dev/null"]
        stdout: SplitParser {
            onRead: data => {
